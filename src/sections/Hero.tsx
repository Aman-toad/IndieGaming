      ...
      <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-[#dfdff2]' >
        <div>
          <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
            <div onClick={handlMiniVdClick} className='origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100'>
              <video
                ref={nextVideoRef}
        ...
        <div className='absolute l0 top-0 z-40 size-full'>
          <div className='mt-24 px-5 sm:px-10'>
            <h1 className='special-font hero-heading text-blue-200'>
              THE <b>C</b>YCLE
            </h1>
            <p className="mb-5 max-w-64 font-['robert-regular'] text-blue-100">
              HYPER LIGHT BREAKER <br /> OVERTHROW THE ABYSS
            </p>
